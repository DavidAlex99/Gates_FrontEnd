...
class QuejaFarmaciaFormPage extends StatefulWidget {
  final int farmaciaId;

  QuejaFarmaciaFormPage({required this.farmaciaId});

  @override
  _QuejaFarmaciaFormPageState createState() => _QuejaFarmaciaFormPageState();
}

class _QuejaFarmaciaFormPageState extends State<QuejaFarmaciaFormPage> {
    ...
    try {
      ...
      final response = await http.post(
        Uri.parse(
            ...
            "http://127.0.0.1:8000/farmacias/${widget.farmaciaId}/crear_queja/"),
        headers: {
